...
| 深度 | 在分支树中的深度 |
| 下界 | 节点LP松弛下界 |
| 状态 | processed/pruned/infeasible |
| 分支类型 | arc/pattern |
| 分支方向 | left/right |
| CG迭代次数 | 列生成迭代数 |
| 是否整数 | 解是否为整数 |
...
**筛选功能**:
- 按状态筛选: 全部 / processed / pruned / infeasible
- 按分支类型筛选: 全部 / arc / pattern
...
| AnalysisWidget | analysis_widget.cpp | 求解分析页面 |
